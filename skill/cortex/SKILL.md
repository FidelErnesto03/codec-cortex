...
HDL:session_close|specification|brain.cortex|producir/actualizar SES with input,output,outcome,date; producir LNG si hubo error o patrón relevante; producir AUD si se verificó algo; producir RSK si quedó riesgo activo; producir NXT si queda acción pendiente; producir HCORTEX de cierre si humano necesita auditoría
