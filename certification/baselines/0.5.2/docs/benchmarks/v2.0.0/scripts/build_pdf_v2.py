...
Salida: /home/z/my-project/download/benchmark-cortex-v2/Benchmark_CODEC_CORTEX_v2.0.pdf
"""
...
class BenchmarkDocTemplate(BaseDocTemplate):
    ...
    def _body_header(self, canvas, doc):
        ...
        canvas.drawString(1.8 * cm, page_h - 0.8 * cm, "Benchmark CODEC-CORTEX v2.0.0")
...
def build_cover() -> List:
    ...
    summary_data = [
        ...
        [Paragraph("<b>CODEC-CORTEX</b>", STYLES["TableCell"]),
         Paragraph("v0.3.1 (CLI 2.4.0, bidirectional)", STYLES["TableCell"])],
...
def main():
    out_pdf = "/home/z/my-project/download/benchmark-cortex-v2/Benchmark_CODEC_CORTEX_v2.0.pdf"
    reports_dir = Path("/home/z/my-project/download/benchmark-cortex-v2/reports")
    images_dir = Path("/home/z/my-project/download/benchmark-cortex-v2")  # images referenced as "diagrams/xxx.png"

    doc = BenchmarkDocTemplate(
        out_pdf,
        pagesize=A4,
        title="Benchmark CODEC-CORTEX v2.0.0",
    ...
    # Reports
    reports = [
        ("scientific_report_v2.md", "1. Informe Científico Principal v2.0.0"),
        ("claim_matrix_v2.md", "2. Matriz de Claims v2.0.0"),
        ("regression_report_v2.md", "3. Reporte de Regresión v2.0.0"),
    ]
