...
Salida: /home/z/my-project/download/benchmark-cortex-v21/Benchmark_CODEC_CORTEX_v2.1.pdf
"""
...
class BenchmarkDocTemplate(BaseDocTemplate):
    ...
    def _body_header(self, canvas, doc):
        ...
        canvas.drawString(1.8 * cm, page_h - 0.8 * cm, "Benchmark CODEC-CORTEX v2.1.0")
...
def build_cover() -> List:
    ...
    summary_data = [
        ...
        [Paragraph("<b>CODEC-CORTEX</b>", STYLES["TableCell"]),
         Paragraph("v0.3.2 (CLI v0.3.2, corpus VIEW)", STYLES["TableCell"])],
...
def main():
    out_pdf = "/home/z/my-project/download/benchmark-cortex-v21/Benchmark_CODEC_CORTEX_v2.1.pdf"
    reports_dir = Path("/home/z/my-project/download/benchmark-cortex-v21/reports")
    images_dir = Path("/home/z/my-project/download/benchmark-cortex-v21")  # images referenced as "diagrams/xxx.png"

    doc = BenchmarkDocTemplate(
        out_pdf,
        pagesize=A4,
        title="Benchmark CODEC-CORTEX v2.1.0",
    ...
    # Reports
    reports = [
        ("scientific_report_v21.md", "1. Informe Científico Principal v2.1.0"),
        ("claim_matrix_v21.md", "2. Matriz de Claims v2.1.0"),
        ("regression_report_v21.md", "3. Reporte de Regresión v2.1.0"),
    ]
