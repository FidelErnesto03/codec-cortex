...
> **NOTA DE ESTADO:** A v0.4.1 el glosario canónico en `skill/cortex/SKILL.md` $0 define 30+ microtokens — abreviaturas compactas que se expanden a términos completos durante el parseo CORTEX. DEBEN registrarse en $0 antes del primer uso y NO DEBEN expandirse dentro de palabras o bloques verbatim.
