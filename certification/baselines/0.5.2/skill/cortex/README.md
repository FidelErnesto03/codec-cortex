...
After installation, verify the artifact is intact (v0.4.1 — canonical command names):
...
> v0.4.1 — Naming canónico: `cortex inspect`, `cortex roundtrip-bidir`,
...
**Canonical HCORTEX spec (human reference):** `skill/hcortex/SKILL_HCORTEX.md` — v1.3.0.
