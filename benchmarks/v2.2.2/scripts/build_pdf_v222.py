...
Salida: /home/z/my-project/download/benchmark-cortex-v222/Benchmark_CODEC_CORTEX_v2.2.2.pdf
"""
...
class BenchmarkDocTemplate(BaseDocTemplate):
    ...
    def _body_header(self, canvas, doc):
        ...
        canvas.drawString(1.8 * cm, page_h - 0.8 * cm, "Benchmark CODEC-CORTEX v2.2.2 (Bridge + 4 Families)")
...
def build_cover() -> List:
    ...
    summary_data = [
        ...
        [Paragraph("<b>CODEC-CORTEX</b>", STYLES["TableCell"]),
         Paragraph("v0.3.6 (Bridge LoCoMo/LongMemEval + 4 familias + threat model)", STYLES["TableCell"])],
...
def main():
    out_pdf = "/home/z/my-project/download/benchmark-cortex-v222/Benchmark_CODEC_CORTEX_v2.2.2.pdf"
    reports_dir = Path("/home/z/my-project/download/benchmark-cortex-v222/reports")
    images_dir = Path("/home/z/my-project/download/benchmark-cortex-v222")  # images referenced as "diagrams/xxx.png"

    doc = BenchmarkDocTemplate(
        out_pdf,
        pagesize=A4,
        title="Benchmark CODEC-CORTEX v2.2.2 (Bridge + 4 Families)",
    ...
    # Reports
    reports = [
        ("scientific_report_v222.md", "1. Informe Científico v2.2.2"),
