...
<!-- cortex-entry {"name":"determinism","namespace":null,"section":"1","shape":"attrs","symbol":"KNW"} -->
### KNW:determinism · knowledge

| # | Campo | Valor |
| --- | --- | --- |
| 1 | `topic` | `Determinismo` |
| 2 | `content` | `"Misma entrada produce igual estructura."` |
| 3 | `status` | `current` |
| 4 | `evidence` | `"Fase 3"` |
