...
<!-- cortex-entry {"name":"first","namespace":null,"section":"1","shape":"attrs","symbol":"KNW"} -->
### KNW:first · knowledge

| # | Campo | Valor |
| --- | --- | --- |
| 1 | `topic` | `Primero` |
| 2 | `content` | `"El orden es significativo."` |

<!-- cortex-entry {"name":"second","namespace":null,"section":"1","shape":"attrs","symbol":"KNW"} -->
### KNW:second · knowledge

| # | Campo | Valor |
| --- | --- | --- |
| 1 | `topic` | `Segundo` |
| 2 | `content` | `"Se conserva después."` |
