...
TST:task{id:"GEN-4",instruction:"Las secciones deben usar $N: TITULO. Las ideas deben usar SIGILO:nombre{atributos}."}
$4: VALIDACION — Uso interno, no incluir en la respuesta
...
VAL:validation{check:"Usa $N: TITULO para secciones",expected:"si",weight:critico}
