...
> **NOTA DE ESTADO:** Este documento es especificacion o diseno. La consolidacion manual asistida por agente es uso actual del Skill. La deteccion automatica de recurrencia, promocion, decay y reordenamiento estructural por runtime son planificadas o futuras salvo implementacion verificada.
