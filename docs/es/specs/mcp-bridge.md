...
> **NOTA DE ESTADO:** Este documento es especificacion o diseno. A v0.3.6 el codec, el CLI (incluida la seguridad E2 y el protocolo de documentacion E3) y el render HCORTEX estan implementados en cli/. El runtime y el servidor MCP en si siguen siendo planificados o futuros; el handler map siguiente es el contrato de diseno que el futuro servidor MCP expondra.
