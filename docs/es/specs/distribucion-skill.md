...
> **Versión:** 1.1 · alineada a proyecto v0.3.7 · 2026-07-01
...
```bash
# v0.3.7 — nombres canónicos (los alias v2-* siguen aceptados con WARNING):
