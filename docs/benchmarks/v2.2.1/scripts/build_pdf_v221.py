...
Salida: /home/z/my-project/download/benchmark-cortex-v221/Benchmark_CODEC_CORTEX_v2.2.1.pdf
"""
...
class BenchmarkDocTemplate(BaseDocTemplate):
    ...
    def _body_header(self, canvas, doc):
        ...
        canvas.drawString(1.8 * cm, page_h - 0.8 * cm, "Benchmark CODEC-CORTEX v2.2.1 (PyPI Comparative)")
...
def build_cover() -> List:
    ...
    summary_data = [
        ...
        [Paragraph("<b>CODEC-CORTEX</b>", STYLES["TableCell"]),
         Paragraph("v0.3.6 (Comparativo PyPI: 220 paquetes cortex)", STYLES["TableCell"])],
...
def main():
    out_pdf = "/home/z/my-project/download/benchmark-cortex-v221/Benchmark_CODEC_CORTEX_v2.2.1.pdf"
    reports_dir = Path("/home/z/my-project/download/benchmark-cortex-v221/reports")
    images_dir = Path("/home/z/my-project/download/benchmark-cortex-v221")  # images referenced as "diagrams/xxx.png"

    doc = BenchmarkDocTemplate(
        out_pdf,
        pagesize=A4,
        title="Benchmark CODEC-CORTEX v2.2.1 (PyPI Comparative)",
    ...
    # Reports
    reports = [
        ("scientific_report_v221.md", "1. Informe Científico Comparativo v2.2.1"),
