...
Salida: /home/z/my-project/download/benchmark-cortex-v22/Benchmark_CODEC_CORTEX_v2.2.pdf
"""
...
class BenchmarkDocTemplate(BaseDocTemplate):
    ...
    def _body_header(self, canvas, doc):
        ...
        canvas.drawString(1.8 * cm, page_h - 0.8 * cm, "Benchmark CODEC-CORTEX v2.2.0")
...
def main():
    out_pdf = "/home/z/my-project/download/benchmark-cortex-v22/Benchmark_CODEC_CORTEX_v2.2.pdf"
    reports_dir = Path("/home/z/my-project/download/benchmark-cortex-v22/reports")
    images_dir = Path("/home/z/my-project/download/benchmark-cortex-v22")  # images referenced as "diagrams/xxx.png"

    doc = BenchmarkDocTemplate(
        out_pdf,
        pagesize=A4,
        title="Benchmark CODEC-CORTEX v2.2.0",
    ...
    # Reports
    reports = [
        ("scientific_report_v22.md", "1. Informe Científico Principal v2.2.0"),
        ("claim_matrix_v22.md", "2. Matriz de Claims v2.2.0"),
        ("regression_report_v22.md", "3. Reporte de Regresión v2.2.0"),
    ]
